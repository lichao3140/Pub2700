...
package com.dpower.pub.dp2700.view.wheel;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF9C27B0;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF009688;
	...
	/** label Text size */
	public  int VALUE_TEXT_SIZE = 25;
	
	/** Items Text size */
	public  int ITEMS_TEXT_SIZE = 22;
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0x00000000);
		}
