 ...
 * 呼叫管理中心
 */
public class CallManagementActivity extends BaseActivity implements
	...
	private boolean mIsCallGuard = false;
	...
	public void onRingTimeOut(int CallSessionID, int MsgType, String MsgContent) {
		...
		if (DPFunction.getCallOutSize() == 0 && !mIsCallGuard) {
			MyToast.show(R.string.ring_time_out);
			int temp = DPFunction.callSecurity();
			if (temp == 0) {
